...
export const es: I18nDictionary = {
  ...
  "sessions.no_active_session": "⚠️ No hay sesión activa en este tema.",
  "sessions.summary.header": "📋 **Resumen de sesión**\n\n**{title}**",
  "sessions.summary.id": "ID: `{id}`",
  "sessions.summary.tokens": "Tokens: {used} / {limit}",
  "sessions.summary.directory": "Proyecto: `{dir}`",
  "sessions.button.hide_message": "🙈 Ocultar este mensaje",
  "sessions.button.close_session": "🔒 Cerrar sesión",
  "sessions.message_hidden": "Mensaje ocultado",
  "sessions.hide_error": "No se pudo ocultar el mensaje",
  "sessions.session_closed": "Sesión cerrada",
  "sessions.closed_notification": "✅ Sesión cerrada: {title}",
  "sessions.close_error": "No se pudo cerrar la sesión",
  ...
  "config.menu": "⚙️ **Ajustes**\n\nGestionar servidores MCP, plugins, proveedores o ver config raw:",
  "config.btn.manage": "🔌 MCP / Plugins / Proveedores",
  "config.btn.raw": "📋 Ver Config Raw",
  "config.btn.close": "❌ Cerrar",
  "config.raw_display": "📋 **Config Raw:**\n\n<pre>{config}</pre>",
  "config.error": "Ocurrió un error",
  "config.abort_text": "Envía texto o /abort para cancelar.",

  "manage.menu": "🔧 **Gestionar OpenCode**\n\nElige una sección:",
  "manage.btn.mcp": "Servidores MCP",
  "manage.btn.plugins": "Plugins",
  "manage.btn.providers": "Proveedores",
  "manage.btn.config": "Configuración",
  "manage.btn.close": "Cerrar",
  ...
  "ssh.usage": "🔧 Configuración SSH para Git\n\nComandos:\n/ssh list - Mostrar todos los mapeos\n/ssh add <user> <host> <clave-privada> - Agregar clave SSH directamente\n/ssh remove <host> <user> - Eliminar mapeo\n\nEjemplo: /ssh add hoangxg4 github.com -----BEGIN OPENSSH PRIVATE KEY-----...\nEjemplo: /ssh add dev git.myserver.com -----BEGIN OPENSSH PRIVATE KEY-----...\n\nFunciona con cualquier host Git: GitHub, GitLab, Bitbucket, self-hosted, etc.",
  ...
  "ssh.add_usage": "Uso: /ssh add <user> <host> <contenido-clave-privada>\nEjemplo: /ssh add hoangxg4 github.com -----BEGIN OPENSSH PRIVATE KEY-----\\n...",
  "ssh.remove_usage": "Uso: /ssh remove <host> <user>\nEjemplo: /ssh remove github.com hoangxg4",
  "ssh.unsupported_host": "❌ Host no soportado: {host}\nHosts soportados: {supported}",
  "ssh.invalid_host": "❌ Nombre de host inválido: {host}",
  "ssh.invalid_key": "❌ Clave privada SSH inválida. El contenido debe incluir 'BEGIN' y 'PRIVATE KEY'.",
