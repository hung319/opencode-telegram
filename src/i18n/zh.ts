...
export const zh: I18nDictionary = {
  ...
  "sessions.no_active_session": "⚠️ 此主题中没有活动会话。",
  "sessions.summary.header": "📋 **会话摘要**\n\n**{title}**",
  "sessions.summary.id": "ID: `{id}`",
  "sessions.summary.tokens": "Tokens: {used} / {limit}",
  "sessions.summary.directory": "项目: `{dir}`",
  "sessions.button.hide_message": "🙈 隐藏此消息",
  "sessions.button.close_session": "🔒 关闭会话",
  "sessions.message_hidden": "消息已隐藏",
  "sessions.hide_error": "无法隐藏消息",
  "sessions.session_closed": "会话已关闭",
  "sessions.closed_notification": "✅ 会话已关闭: {title}",
  "sessions.close_error": "无法关闭会话",
  ...
  "config.menu": "⚙️ **设置**\n\n管理 MCP 服务器、插件、提供者或查看原始配置:",
  "config.btn.manage": "🔌 MCP / 插件 / 提供者",
  "config.btn.raw": "📋 查看原始配置",
  "config.btn.close": "❌ 关闭",
  "config.raw_display": "📋 **原始配置:**\n\n<pre>{config}</pre>",
  "config.error": "发生错误",
  "config.abort_text": "发送文本或 /abort 取消。",

  "manage.menu": "🔧 **管理 OpenCode**\n\n选择部分:",
  "manage.btn.mcp": "MCP 服务器",
  "manage.btn.plugins": "插件",
  "manage.btn.providers": "提供者",
  "manage.btn.config": "配置",
  "manage.btn.close": "关闭",
