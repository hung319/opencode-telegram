export const en = {
  ...
  "sessions.no_active_session": "⚠️ No active session in this topic.",
  "sessions.summary.header": "📋 **Session Summary**\n\n**{title}**",
  "sessions.summary.id": "ID: `{id}`",
  "sessions.summary.tokens": "Tokens: {used} / {limit}",
  "sessions.summary.directory": "Project: `{dir}`",
  "sessions.button.hide_message": "🙈 Hide this message",
  "sessions.button.close_session": "🔒 Close session",
  "sessions.message_hidden": "Message hidden",
  "sessions.hide_error": "Failed to hide message",
  "sessions.session_closed": "Session closed",
  "sessions.closed_notification": "✅ Session closed: {title}",
  "sessions.close_error": "Failed to close session",
  ...
  "config.btn.raw": "📋 View Raw Config",
  "config.btn.close": "❌ Close",
  "config.raw_display": "📋 **Raw Config:**\n\n<pre>{config}</pre>",
  "config.error": "An error occurred",
  "config.abort_text": "Send text or /abort to cancel.",

  "manage.menu": "🔧 **Manage OpenCode**\n\nChoose a section:",
  "manage.btn.mcp": "MCP Servers",
  "manage.btn.plugins": "Plugins",
  "manage.btn.providers": "Providers",
  "manage.btn.config": "Config",
  "manage.btn.close": "Close",
  ...
  "bot.server_restarted": "🔄 **OpenCode Server Restarted**\n\nThe server crashed but was automatically restarted by the bot.",
