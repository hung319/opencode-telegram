export const vi = {
  ...
  "status.line.managed_yes": "Được khởi động bởi bot: Có",
  "status.line.managed_no": "Được khởi động bởi bot: Không (process bên ngoài)",
  ...
  "status.dm.hint": "Sử dụng luồng topic trong nhóm để chạy phiên OpenCode.",
  ...
  "projects.locked.callback": "Chuyển dự án bị khóa cho nhóm này.",

  "sessions.project_not_selected":
    "🏗 Project is not selected.\n\nFirst select a project with /projects.",
  "sessions.empty": "📭 No sessions found.\n\nCreate a new session with /new.",
  "sessions.select": "Chọn phiên:",
  ...
  "sessions.general_overview": "Tổng quan các phiên trong topic:",
  "sessions.general_item": "• {topic} (thread #{thread}) - {status}",
  "sessions.general_empty": "Chưa có topic phiên nào. Sử dụng /new để tạo.",
  ...
  "sessions.resume.assistant_title": "Tin nhắn agent cuối:",
  "sessions.resume.last_turn_title": "Tin nhắn hiển thị cuối:",
  ...
  "variant.change_error_callback": "❌ Không thay đổi được variant",
  ...
  "context.general_not_available_callback": "Mở topic phiên trước.",
  "context.callback_session_not_found": "Không tìm thấy phiên",
  "context.callback_compacting": "⏳ Đang compact context...",
  ...
  "question.answer_already_received": "Đã nhận được câu trả lời, vui lòng đợi...",
  ...
  "question.use_custom_button_first":
    '⚠️ To send text, tap "🔤 Trả lời tùy chỉnh" for the current question first.',
  ...
  "commands.select": "Chọn lệnh OpenCode:",
  ...
  "cli.args.mode_only_start": "Tùy chọn --mode chỉ được hỗ trợ cho các lệnh start và config",
