...
export const de: I18nDictionary = {
  ...
  "status.mcp.header": "🔌 MCP-Server:",
  "status.mcp.connected": "🟢",
  "status.mcp.disabled": "⚫",
  "status.mcp.failed": "🔴",
  "status.mcp.unknown": "❓",
  "status.lsp.header": "🔤 LSP-Server:",
  "status.lsp.running": "🟢",
  "status.lsp.stopped": "🔴",
  "status.formatter.header": "✨ Formatter:",
  ...
  "sessions.no_active_session": "⚠️ Keine aktive Sitzung in diesem Thema.",
  "sessions.summary.header": "📋 **Sitzungsübersicht**\n\n**{title}**",
  "sessions.summary.id": "ID: `{id}`",
  "sessions.summary.tokens": "Tokens: {used} / {limit}",
  "sessions.summary.directory": "Projekt: `{dir}`",
  "sessions.button.hide_message": "🙈 Diese Nachricht verbergen",
  "sessions.button.close_session": "🔒 Sitzung schließen",
  "sessions.message_hidden": "Nachricht verborgen",
  "sessions.hide_error": "Nachricht konnte nicht verborgen werden",
  "sessions.session_closed": "Sitzung geschlossen",
  "sessions.closed_notification": "✅ Sitzung geschlossen: {title}",
  "sessions.close_error": "Sitzung konnte nicht geschlossen werden",
  ...
  "pinned.line.created": "Erstellt: {time}",
  "pinned.line.messages": "Nachrichten: {count}",
  ...
  "config.menu": "⚙️ **Einstellungen**\n\nMCP-Server, Plugins, Anbieter verwalten oder Raw-Konfiguration anzeigen:",
  "config.btn.manage": "🔌 MCP / Plugins / Anbieter",
  "config.btn.raw": "📋 Raw-Konfiguration anzeigen",
  "config.btn.close": "❌ Schließen",
  "config.raw_display": "📋 **Raw-Konfiguration:**\n\n<pre>{config}</pre>",
  "config.error": "Ein Fehler ist aufgetreten",
  "config.abort_text": "Text senden oder /abort zum Abbrechen.",

  "manage.menu": "🔧 **OpenCode verwalten**\n\nBereich wählen:",
  "manage.btn.mcp": "MCP-Server",
  "manage.btn.plugins": "Plugins",
  "manage.btn.providers": "Anbieter",
  "manage.btn.config": "Konfiguration",
  "manage.btn.close": "Schließen",
