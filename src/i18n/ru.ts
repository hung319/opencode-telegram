...
export const ru: I18nDictionary = {
  ...
  "sessions.no_active_session": "⚠️ Нет активной сессии в этой теме.",
  "sessions.summary.header": "📋 **Сводка сессии**\n\n**{title}**",
  "sessions.summary.id": "ID: `{id}`",
  "sessions.summary.tokens": "Токены: {used} / {limit}",
  "sessions.summary.directory": "Проект: `{dir}`",
  "sessions.button.hide_message": "🙈 Скрыть это сообщение",
  "sessions.button.close_session": "🔒 Закрыть сессию",
  "sessions.message_hidden": "Сообщение скрыто",
  "sessions.hide_error": "Не удалось скрыть сообщение",
  "sessions.session_closed": "Сессия закрыта",
  "sessions.closed_notification": "✅ Сессия закрыта: {title}",
  "sessions.close_error": "Не удалось закрыть сессию",
  ...
  "config.menu": "⚙️ **Настройки**\n\nУправление MCP серверами, плагинами, провайдерами или просмотр raw config:",
  "config.btn.manage": "🔌 MCP / Плагины / Провайдеры",
  "config.btn.raw": "📋 Просмотр Raw Config",
  "config.btn.close": "❌ Закрыть",
  "config.raw_display": "📋 **Raw Config:**\n\n<pre>{config}</pre>",
  "config.error": "Произошла ошибка",
  "config.abort_text": "Отправьте текст или /abort для отмены.",

  "manage.menu": "🔧 **Управление OpenCode**\n\nВыберите раздел:",
  "manage.btn.mcp": "MCP Серверы",
  "manage.btn.plugins": "Плагины",
  "manage.btn.providers": "Провайдеры",
  "manage.btn.config": "Конфигурация",
  "manage.btn.close": "Закрыть",
