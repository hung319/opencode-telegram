...
const COMMAND_DEFINITIONS: BotCommandI18nDefinition[] = [
  ...
  { command: BOT_COMMAND.CLONE, descriptionKey: "cmd.description.clone" },
  { command: BOT_COMMAND.LS, descriptionKey: "cmd.description.ls" },
  { command: BOT_COMMAND.OPEN, descriptionKey: "cmd.description.open" },
  { command: BOT_COMMAND.WORKTREE, descriptionKey: "cmd.description.worktree" },
